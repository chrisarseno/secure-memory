  ...
  return (
    <Card className="bg-card border-border mt-8">
      ...
      <CardContent>
        ...
        <div className="relative h-64 bg-muted/20 rounded-lg border border-border overflow-hidden" data-testid="knowledge-graph-preview">
          <div className="absolute inset-0 flex items-center justify-center">
            ...
            <div className="relative w-full h-full p-8">
              ...
              {/* Surrounding nodes */}
              {graphData?.nodes?.slice(1).map((node, index) => {
